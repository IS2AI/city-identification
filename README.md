...
<h6 align="center"> Figure 1: Cities and their corresponding raw sattelite views from one of the sites used for dataset and respective city identification model </h6>
